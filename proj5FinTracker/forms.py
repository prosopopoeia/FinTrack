...
class FindByYearForm(forms.Form):
    year = forms.IntegerField(initial=datetime.date.today() - datetime.timedelta(-3),
                                          widget= forms.TextInput(attrs={'id':'bydate'}))                                           

class dataView(forms.Form):
    dataview = forms.CharField(max_length=125, widget= forms.TextInput(attrs={'id':'dv'}))    
